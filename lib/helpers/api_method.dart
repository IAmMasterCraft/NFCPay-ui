...
class ApiMethod {
  ...
  // Param get method
  Future<Map<String, dynamic>?> paramGet(String url, Map<String, String> body, {int code = 200}) async {
    log.i(
  ...
  // Post Method
  Future<Map<String, dynamic>?> post(String url, Map<String, dynamic> body, {int code = 201}) async {
    try {
      log.i(
  ...
  // Post Method
  Future<Map<String, dynamic>?> multipart( String url, Map<String, String> body, String filepath, String filedName, {int code = 200}) async {
    try {
      log.i(
  ...
  // Delete method
  Future<Map<String, dynamic>?> delete(String url, {int code = 202, bool isLogout = false}) async {
    log.i(
...
// LocalStorage.clear();
  ...
  Future<Map<String, dynamic>?> put(String url, Map<String, String> body, {int code = 202}) async {
    try {
      log.i(
